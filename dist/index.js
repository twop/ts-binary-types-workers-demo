 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */n.d(e,"b",(function(){return B})),n.d(e,"a",(function(){return s})),n.d(e,"c",(function(){return F})),
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const B=(t,...e)=>new x(t,e,"html",C)},function(t,e,n){"use strict";n.d(e,"a",(function(){return c})),n.d(e,"c",(function(){return m})),n.d(e,"b",(function(){return g})),n.d(e,"f",(function(){return v})),n.d(e,"e",(function(){return y})),n.d(e,"d",(function(){return w}));var r=n(0);const s=Object(r.g)(r.a,r.c),i=Object(r.f)({bool:r.a,i32vec:Object(r.i)(r.c)}),o=()=>({bool:x(),i32vec:h(5,d)}),a=Object(r.h)({unit:null,val:i}),c=Object(r.f)({str:Object(r.d)(r.e),f64:Object(r.d)(r.b),tuple:Object(r.d)(s),union:Object(r.d)(a),struct:Object(r.d)(i)}),u=Object(r.i)(c),l=()=>1e6*Math.random(),d=()=>Math.floor(1e6*Math.random()*(Math.random()>.5?1:-1)),h=(t,e)=>Array.from({length:t},e),p="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";function f(t){let e="";for(let n=0;n<t;n++)e+=p.charAt(Math.floor(Math.random()*p.length));return e}const m=({str:t,f64:e,tuple:n,union:r,struct:i})=>({str:t?f(100):void 0,f64:e?l():void 0,tuple:n?s(x(),d()):void 0,struct:i?o():void 0,union:r?Math.random()<.5?a.unit:a.val(o()):void 0}),g=(t,e)=>h(t,()=>m(e)),b=u[r.j].write,v=(t,e)=>{const{arr:n}=b({arr:e,pos:0},t);return n},_=u[r.j].read,y=t=>{return _({arr:t,pos:0})};function x(){return Math.random()>.5}const w=(t,e)=>console.info(t+" took: %dms",e)},function(t,e,n){"use strict";n.d(e,"a",(function(){return i}));var r=n(2);
/**
 * @license
